...
<body>
    ...
    $query = "SELECT Post.*, Book.Title AS BookTitle, Author.Name AS AuthorName FROM Post LEFT JOIN Book ON Post.Book_ID = Book.Book_ID LEFT JOIN Author ON Book.Author_ID = Author.Author_ID WHERE Post.Post_ID = $id";
